...
//    projectService.save(createDummyProject());
  ...
  /*private Project createDummyProject() {
    ...
    description.setTheme("theme");
    description.setRequiredTime("requiredTime");
    ...
    description.setWebaddress("webaddress");
    description.setGoal("goal");
    description.setActuality("actuality");
    ...
    description.setPartners("partners");
    description.setDate(new Date());

    // cost items for budget
    ...
    budget.setTotalFromProgram(70000);
    budget.setTotalFromOtherSources(50000);
    budget.setCostItemFee(costItemFee);
    ...
    interviewEvaluations.add(interviewEvaluation);
    ...
    project.setApprovedToSecondStage(false);
    project.setTotalEvalFirstStage(33);
